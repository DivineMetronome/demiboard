(function (global, factory) {
	...
	const normalizeRef = ({ ref: ref$$1 }) => (ref$$1 != null
	    ? isArray(ref$$1)
	        ? ref$$1
	...
	*/
	...
	function instanceWatch(source, cb, options) {
	    ...
	    const stop$$1 = watch(getter, cb.bind(publicThis), options);
	...
	function convert$1(element) {
	    var props = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
	    var data = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};

	    var children = (element.children || []).map(convert$1);
	    ...
	    var _ref = Array.isArray(data) ? data[0] : data,
	        ...
	        dClass = _ref$class === undefined ? {} : _ref$class,
	        _ref$style = _ref.style,
	        dStyle = _ref$style === undefined ? {} : _ref$style,
	        _ref$attrs = _ref.attrs,
	        dAttrs = _ref$attrs === undefined ? {} : _ref$attrs,
	        remainingData = objectWithoutProperties(_ref, ['class', 'style', 'attrs']);
	    ...
	    if (typeof element === 'string') {
	        ...
	        }, mixins.attrs, dAttrs, remainingData, {
	            props: props
	        }), children);
	    }
	}
	...
	var FontAwesomeIcon = {
	  ...
	  render: function render(props, data) {
	    ...
	    return convert$1(abstract[0], {}, data[0]);
	  }
	};
